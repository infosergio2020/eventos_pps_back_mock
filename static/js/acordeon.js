...
class Accordion {
    ...
    toggle(t) {
        t !== this.open && (this.open = t, this.buttonEl.setAttribute("aria-expanded", `${t}`), t ? (this.contentEl.removeAttribute("hidden"), console.log(this.contentEl.children[0].children[0].children), this.contentEl.children[0].children[0].children[0].focus()) : this.contentEl.setAttribute("hidden", ""))
    }
    open() {
        this.toggle(!0)
    }
