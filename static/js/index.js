// CONSTANTES GLOBALES
const TITULO = ' Estas saliendo de la página <strong>Generar Conciencia</strong> hacia la página de <strong>Citadine</strong>. ¿Desea continuar?';
...
const CLARIN = 'https://www.clarin.com/ciudades/critica-situacion-plata-cientos-evacuados_0_S19zAYFiDXg.html';
const HOY = 'https://diariohoy.net/adjuntos/archivos/000/024/0000024100.pdf';
const ELDIA = 'https://www.eldia.com/nota/2013-4-3--el-agua-ya-esta-en-un-metro-y-medio-por-favor-que-alguien-nos-mande-botes';
// EJECUTAR SOLO CUANDO EL DOM ESTE CARGADO
...
// FUNCIONES Y VARIABLES FUERA DEL EVENTO ONLOADDOM

// funcion que dado un enter o espacio abre o cierra el sidebar
const onkey_tab = (e) => {
    switch (e.keyCode) {
      case 13:
      case 27:
  ...
  // funcion que se encarga de mostrar/ocultar el sidebar asi como tambien habilitar/desabilitar el foco
  toggleMenu = () => {
...
null != e && e.addEventListener("click", (e) => { custom_popup(TITULO,abri_website,ELDIA); });

e = document.getElementById('diario-2-2');
null != e && e.addEventListener("click", (e) => { custom_popup(TITULO,abri_website,HOY); });

e = document.getElementById('diario-3-3');
null != e && e.addEventListener("click", (e) => { custom_popup(TITULO,abri_website,CLARIN); });

e = document.getElementById('diario-4-4');
null != e && e.addEventListener("click", (e) => { custom_popup(TITULO,abri_website,NACION); });
...
if (null != e)
  for (let i = 0; i < e.length; i++) {
    e[i].addEventListener("click", (e) => { custom_popup(TITULO,abri_website,CITADINE_AZUL); });
  }
e = document.getElementsByClassName('citadineVerde');
if (null != e)
  for (let i = 0; i < e.length; i++) {
    e[i].addEventListener("click", (e) => { custom_popup(TITULO,abri_website,CITADINE_VERDE); });
  }

  // MODULARIZANDO EL POPUP
  ...
  function abri_website(url) { window.open(url, '_blank') }