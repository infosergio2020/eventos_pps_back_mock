...
!(function (t, e) {
        ...
        (w.prototype.buildStructure = function () {
          ...
          if (!(this.$container && this.$container.get())) {
            ...
            this.settings.controls &&
              (e =
                '<button tabindex="1" type="button" id="' +
                this.getIdName("lg-prev") +
                '" aria-label="' +
                this.settings.strings.previousSlide +
                '" class="lg-prev lg-icon"> ' +
                this.settings.prevHtml +
                ' </button>\n                <button tabindex="2" type="button" id="' +
            ...
            var n = this.settings.ariaLabelledby
              ...
              l =
                this.settings.closable && this.settings.showCloseIcon
                  ? '<button tabindex="3" type="button" aria-label="' +
  ...
  //quedarse con la imagen seleccionada
  const $dynamicGallery1 = document.getElementById('img1');
  const $dynamicGallery2 = document.getElementById('img2');
  const $dynamicGallery3 = document.getElementById('img3');
  const $dynamicGallery4 = document.getElementById('img4');
  const $dynamicGallery5 = document.getElementById('img5');
  

  $dynamicGallery1.addEventListener('click', function () {
